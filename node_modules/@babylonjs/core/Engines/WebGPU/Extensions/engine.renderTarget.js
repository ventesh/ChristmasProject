...
ThinWebGPUEngine.prototype.createRenderTargetTexture = function (size, options) {
    ...
    const texture = fullOptions.colorAttachment || (fullOptions.noColorAttachment ? null : this._createInternalTexture(size, options, true, 5 /* InternalTextureSource.RenderTarget */));
